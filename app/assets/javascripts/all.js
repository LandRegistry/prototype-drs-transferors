...
(() => {
                ...
                void 0 === (n = "function" == typeof(o = function() {
                    var t = {
                        removeAttributeValue: function(t, e, o) {
                            var n, i;
                            t.getAttribute(e) && (t.getAttribute(e) == o ? t.removeAttribute(e) : (n = new RegExp("(^|\\s)" + o + "(\\s|$)"), (i = t.getAttribute(e).match(n)) && 3 == i.length && t.setAttribute(e, t.getAttribute(e).replace(n, i[1] && i[2] ? " " : ""))))
                        },
                        ...
                        initAll: function(e) {
                            ...
                            var s = o.querySelectorAll('[data-module="moj-rich-text-editor"]');
                            ...
                            var a = o.querySelectorAll('[data-module="moj-search-toggle"]');
                        ...
                        AddAnother: function(t) {
                            this.container = $(t), this.container.data("moj-add-another-initialised") || (this.container.data("moj-add-another-initialised", !0), this.container.on("click", ".moj-add-another__remove-button", $.proxy(this, "onRemoveButtonClick")), this.container.on("click", ".moj-add-another__add-button", $.proxy(this, "onAddButtonClick")), this.container.find(".moj-add-another__add-button, moj-add-another__remove-button").prop("type", "button"))
                        }
                    };
                    return t.AddAnother.prototype.onAddButtonClick = function(t) {
                        ...
                        e.find("[data-name]").each((function(o, n) {
                            var i = n.id;
                            n.name = $(n).attr("data-name").replace(/%index%/, t), n.id = $(n).attr("data-id").replace(/%index%/, t), ($(n).siblings("label")[0] || $(n).parents("label")[0] || e.find('[for="' + i + '"]')[0]).htmlFor = n.id
                        }))
                        ...
                        var e = this.getItems();
                        1 === e.length && e.find(".moj-add-another__remove-button").remove(), e.each($.proxy((function(t, e) {
                        ...
                        this.container = t.container, this.menu = this.container.find(".moj-button-menu__wrapper"), t.menuClasses && this.menu.addClass(t.menuClasses), this.menu.attr("role", "menu"), this.mq = t.mq, this.buttonText = t.buttonText, this.buttonClasses = t.buttonClasses || "", this.keys = {
                            esc: 27,
                            up: 38,
                            down: 40,
                            tab: 9
                        }, this.menu.on("keydown", "[role=menuitem]", $.proxy(this, "onButtonKeydown")), this.createToggleButton(), this.setupResponsiveChecks(), $(document).on("click", $.proxy(this, "onDocumentClick"))
                        ...
                        this.menuButton = $('<button class="govuk-button moj-button-menu__toggle-button ' + this.buttonClasses + '" type="button" aria-haspopup="true" aria-expanded="false">' + this.buttonText + "</button>"), this.menuButton.on("click", $.proxy(this, "onMenuButtonClick")), this.menuButton.on("keydown", $.proxy(this, "onMenuKeyDown"))
                        ...
                        this.container.prepend(this.menuButton), this.hideMenu(), this.removeButtonClasses(), this.menu.attr("role", "menu"), this.container.find(".moj-button-menu__item").attr("role", "menuitem")
                    }, t.ButtonMenu.prototype.enableBigMode = function() {
                        this.menuButton.detach(), this.showMenu(), this.addButtonClasses(), this.menu.removeAttr("role"), this.container.find(".moj-button-menu__item").removeAttr("role")
                    }, t.ButtonMenu.prototype.removeButtonClasses = function() {
                        this.menu.find(".moj-button-menu__item").each((function(t, e) {
                            $(e).hasClass("govuk-button--secondary") && ($(e).attr("data-secondary", "true"), $(e).removeClass("govuk-button--secondary")), $(e).hasClass("govuk-button--warning") && ($(e).attr("data-warning", "true"), $(e).removeClass("govuk-button--warning")), $(e).removeClass("govuk-button")
                        }))
                    }, t.ButtonMenu.prototype.addButtonClasses = function() {
                        this.menu.find(".moj-button-menu__item").each((function(t, e) {
                            "true" == $(e).attr("data-secondary") && $(e).addClass("govuk-button--secondary"), "true" == $(e).attr("data-warning") && $(e).addClass("govuk-button--warning"), $(e).addClass("govuk-button")
                        }))
                        ...
                        "false" == this.menuButton.attr("aria-expanded") ? (this.showMenu(), this.menu.find("[role=menuitem]").first().focus()) : (this.hideMenu(), this.menuButton.focus())
                        ...
                        this.options = t, this.container = this.options.toggleButton.container, this.createToggleButton(), this.setupResponsiveChecks(), this.options.filter.container.attr("tabindex", "-1"), this.options.startHidden && this.hideMenu()
                        ...
                        this.menuButton = $('<button class="govuk-button ' + this.options.toggleButton.classes + '" type="button" aria-haspopup="true" aria-expanded="false">' + this.options.toggleButton.showText + "</button>"), this.menuButton.on("click", $.proxy(this, "onMenuButtonClick")), this.options.toggleButton.container.append(this.menuButton)
                        ...
                        this.options.closeButton && (this.closeButton = $('<button class="moj-filter__close" type="button">' + this.options.closeButton.text + "</button>"), this.closeButton.on("click", $.proxy(this, "onCloseClick")), this.options.closeButton.container.append(this.closeButton))
                        ...
                        this.menuButton.attr("aria-expanded", "false"), this.options.filter.container.addClass("moj-js-hidden"), this.menuButton.text(this.options.toggleButton.showText)
                    }, t.FilterToggleButton.prototype.showMenu = function() {
                        this.menuButton.attr("aria-expanded", "true"), this.options.filter.container.removeClass("moj-js-hidden"), this.menuButton.text(this.options.toggleButton.hideText)
                        ...
                        this.form = t, this.errors = [], this.validators = [], $(this.form).on("submit", $.proxy(this, "onSubmit")), this.summary = e && e.summary ? $(e.summary) : $(".govuk-error-summary"), this.originalTitle = document.title
                        ...
                        this.summary.html(this.getSummaryHtml()), this.summary.removeClass("moj-hidden"), this.summary.attr("aria-labelledby", "errorSummary-heading"), this.summary.focus()
                        ...
                        for (var e = 0, o = this.errors.length; e < o; e++) {
                            var n = this.errors[e];
                            t += "<li>", t += '<a href="#' + this.escapeHtml(n.fieldName) + '">', t += this.escapeHtml(n.message), t += "</a>", t += "</li>"
                        }
                        return (t += "</ul>") + "</div>"
                        ...
                        var o = e.fieldName + "-error",
                            ...
                            a = r.find("legend"),
                            l = r.find("fieldset");
                        r.addClass("govuk-form-group--error"), a.length ? (a.after(n), r.attr("aria-invalid", "true"), t.addAttributeValue(l[0], "aria-describedby", o)) : (s.after(n), i.attr("aria-invalid", "true"), t.addAttributeValue(i[0], "aria-describedby", o))
                        ...
                        o.find(".govuk-error-message").remove(), o.removeClass("govuk-form-group--error"), o.find("[aria-invalid]").attr("aria-invalid", "false");
                        ...
                        }, this.params = $.extend({}, this.defaultParams, t), this.params.container.addClass("moj-multi-file-upload--enhanced"), this.feedbackContainer = this.params.container.find(".moj-multi-file__uploaded-files"), this.setupFileInput(), this.setupDropzone(), this.setupLabel(), this.setupStatusBox(), this.params.container.on("click", ".moj-multi-file-upload__delete", $.proxy(this, "onFileDeleteClick"))
                    }, t.MultiFileUpload.prototype.setupDropzone = function() {
                        this.fileInput.wrap('<div class="moj-multi-file-upload__dropzone" />'), this.dropzone = this.params.container.find(".moj-multi-file-upload__dropzone"), this.dropzone.on("dragover", $.proxy(this, "onDragOver")), this.dropzone.on("dragleave", $.proxy(this, "onDragLeave")), this.dropzone.on("drop", $.proxy(this, "onDrop"))
                    }, t.MultiFileUpload.prototype.setupLabel = function() {
                        this.label = $('<label for="' + this.fileInput[0].id + '" class="govuk-button govuk-button--secondary">' + this.params.dropzoneButtonText + "</label>"), this.dropzone.append('<p class="govuk-body">' + this.params.dropzoneHintText + "</p>"), this.dropzone.append(this.label)
                    }, t.MultiFileUpload.prototype.setupFileInput = function() {
                        this.fileInput = this.params.container.find(".moj-multi-file-upload__input"), this.fileInput.on("change", $.proxy(this, "onFileChange")), this.fileInput.on("focus", $.proxy(this, "onFileFocus")), this.fileInput.on("blur", $.proxy(this, "onFileBlur"))
                        ...
                        t.preventDefault(), this.dropzone.removeClass("moj-multi-file-upload--dragover"), this.feedbackContainer.removeClass("moj-hidden"), this.status.html(this.params.uploadStatusText), this.uploadFiles(t.originalEvent.dataTransfer.files)
                        ...
                        this.feedbackContainer.removeClass("moj-hidden"), this.status.html(this.params.uploadStatusText), this.uploadFiles(t.currentTarget.files), this.fileInput.replaceWith($(t.currentTarget).val("").clone(!0)), this.setupFileInput(), this.fileInput.focus()
                        ...
                        var e = "";
                        return e += '<div class="govuk-summary-list__row moj-multi-file-upload__row">', e += '  <div class="govuk-summary-list__value moj-multi-file-upload__message filename">', e += '<span class="moj-multi-file-upload__filename strong">' + t.name + "</span>", e += "  </div>", (e += '  <div class="govuk-summary-list__actions moj-multi-file-upload__actions govuk-link"> Delete</div>') + "</div>"//,e += '  <div class="govuk-summary-list__value moj-multi-file-upload__message progress1">', e += '<span class="moj-multi-file-upload__progress">0%</span>', e += "  </div>"
                        ...
                        this.feedbackContainer.find(".moj-multi-file-upload__list").append(o), $.ajax({
                            ...
                            success: $.proxy((function(e) {
                                e.error ? (o.find(".moj-multi-file-upload__message").html(this.getErrorHtml(e.error)), this.status.html(e.error.message)) : (o.find(".moj-multi-file-upload__message").html(this.getSuccessHtml(e.success)), this.status.html(e.success.messageText)), o.find(".moj-multi-file-upload__actions").append(this.getDeleteButtonHtml(e.file)), this.params.uploadFileExitHook(this, t, e)
                            }), this),
                            ...
                            xhr: function() {
                                ...
                                return t.upload.addEventListener("progress", (function(t) {
                                    if (t.lengthComputable) {
                                        ...
                                        e = parseInt(100 * e, 10), o.find(".moj-multi-file-upload__progress").text(" " + e + "%")
                                    }
                                }), !1), t
                            }
                        })
                        ...
                        var e = $(t.currentTarget),
                            o = {};
                        o[e[0].name] = e[0].value, $.ajax({
                            url: this.params.deleteUrl,
                            type: "post",
                            dataType: "json",
                            data: o,
                            success: $.proxy((function(t) {
                                t.error || (e.parents(".moj-multi-file-upload__row").remove(), 0 === this.feedbackContainer.find(".moj-multi-file-upload__row").length && this.feedbackContainer.addClass("moj-hidden")), this.params.fileDeleteHook(this, t)
                            }), this)
                        })
                    }), t.MultiSelect = function(t) {
                        this.container = $(t.container), this.container.data("moj-multi-select-initialised") || (this.container.data("moj-multi-select-initialised", !0), this.toggle = $(this.getToggleHtml()), this.toggleButton = this.toggle.find("input"), this.toggleButton.on("click", $.proxy(this, "onButtonClick")), this.container.append(this.toggle), this.checkboxes = $(t.checkboxes), this.checkboxes.on("click", $.proxy(this, "onCheckboxClick")), this.checked = t.checked || !1)
                    }, t.MultiSelect.prototype.getToggleHtml = function() {
                        var t = "";
                        return t += '<div class="govuk-checkboxes__item govuk-checkboxes--small moj-multi-select__checkbox">', t += '  <input type="checkbox" class="govuk-checkboxes__input" id="checkboxes-all">', t += '  <label class="govuk-label govuk-checkboxes__label moj-multi-select__toggle-label" for="checkboxes-all">', t += '    <span class="govuk-visually-hidden">Select all</span>', (t += "  </label>") + "</div>"
                        ...
                        t.target.checked ? this.checkboxes.filter(":checked").length === this.checkboxes.length && (this.toggleButton[0].checked = !0, this.checked = !0) : (this.toggleButton[0].checked = !1, this.checked = !1)
                    }, t.PasswordReveal = function(t) {
                        this.el = t, $el = $(this.el), $el.data("moj-password-reveal-initialised") || ($el.data("moj-password-reveal-initialised", !0), $el.attr("spellcheck", "false"), $el.wrap('<div class="moj-password-reveal"></div>'), this.container = $(this.el).parent(), this.createButton())
                    }, t.PasswordReveal.prototype.createButton = function() {
                        this.button = $('<button type="button" class="govuk-button govuk-button--secondary moj-password-reveal__button">Show <span class="govuk-visually-hidden">password</span></button>'), this.container.append(this.button), this.button.on("click", $.proxy(this, "onButtonClick"))
                    }, t.PasswordReveal.prototype.onButtonClick = function() {
                        "password" === this.el.type ? (this.el.type = "text", this.button.html('Hide <span class="govuk-visually-hidden">password</span>')) : (this.el.type = "password", this.button.html('Show <span class="govuk-visually-hidden">password</span>'))
                    }, "contentEditable" in document.documentElement && (t.RichTextEditor = function(t) {
                        this.options = t, this.options.toolbar = this.options.toolbar || {
                            bold: !1,
                            italic: !1,
                            underline: !1,
                            bullets: !0,
                            numbers: !0
                        }, this.textarea = this.options.textarea, this.container = $(this.textarea).parent(), this.container.data("moj-rich-text-editor-initialised") || (this.container.data("moj-rich-text-editor-initialised", !0), this.createToolbar(), this.hideDefault(), this.configureToolbar(), this.keys = {
                            left: 37,
                            right: 39,
                            up: 38,
                            down: 40
                        }, this.container.on("click", ".moj-rich-text-editor__toolbar-button", $.proxy(this, "onButtonClick")), this.container.find(".moj-rich-text-editor__content").on("input", $.proxy(this, "onEditorInput")), this.container.find("label").on("click", $.proxy(this, "onLabelClick")), this.toolbar.on("keydown", $.proxy(this, "onToolbarKeydown")))
                        ...
                        this.textarea = this.container.find("textarea"), this.textarea.addClass("govuk-visually-hidden"), this.textarea.attr("aria-hidden", !0), this.textarea.attr("tabindex", "-1")
                    }, t.RichTextEditor.prototype.createToolbar = function() {
                        this.toolbar = document.createElement("div"), this.toolbar.className = "moj-rich-text-editor", this.toolbar.innerHTML = this.getEnhancedHtml(), this.container.append(this.toolbar), this.toolbar = this.container.find(".moj-rich-text-editor__toolbar"), this.container.find(".moj-rich-text-editor__content").html(this.textarea.val())
                    }, t.RichTextEditor.prototype.configureToolbar = function() {
                        this.buttons = this.container.find(".moj-rich-text-editor__toolbar-button"), this.buttons.prop("tabindex", "-1"), this.buttons.first().prop("tabindex", "0")
                        ...
                        "false" == this.toggleButton.attr("aria-expanded") ? (this.toggleButton.attr("aria-expanded", "true"), this.options.search.container.removeClass("moj-js-hidden"), this.options.search.container.find("input").first().focus()) : (this.options.search.container.addClass("moj-js-hidden"), this.toggleButton.attr("aria-expanded", "false"))
                    }, t.SortableTable = function(t) {
                        this.table = $(t.table), this.table.data("moj-search-toggle-initialised") || (this.table.data("moj-search-toggle-initialised", !0), this.setupOptions(t), this.body = this.table.find("tbody"), this.createHeadingButtons(), this.createStatusBox(), this.initialiseSortedColumn(), this.table.on("click", "th button", $.proxy(this, "onSortButtonClick")))
                    }, t.SortableTable.prototype.setupOptions = function(t) {
                        t = t || {}, this.statusMessage = t.statusMessage || "Sort by %heading% (%direction%)", this.ascendingText = t.ascendingText || "ascending", this.descendingText = t.descendingText || "descending"
                    }, t.SortableTable.prototype.createHeadingButtons = function() {
                        for (var t, e = this.table.find("thead th"), o = 0; o < e.length; o++)(t = $(e[o])).attr("aria-sort") && this.createHeadingButton(t, o)
                        ...
                        this.status = $('<div aria-live="polite" role="status" aria-atomic="true" class="govuk-visually-hidden" />'), this.table.parent().append(this.status)
                    }, t.SortableTable.prototype.initialiseSortedColumn = function() {
                        var t = this.getTableRowsArray();
                        this.table.find("th").filter('[aria-sort="ascending"], [aria-sort="descending"]').first().each(((e, o) => {
                            var n = $(o).attr("aria-sort"),
                                i = $(o).find("button").attr("data-index"),
                                r = this.sort(t, i, n);
                            this.addRows(r)
                        }))
                    }, t.SortableTable.prototype.onSortButtonClick = function(t) {
                        var e, o = t.currentTarget.getAttribute("data-index"),
                        ...
                        o = (o = o.replace(/%heading%/, t.text())).replace(/%direction%/, this[e + "Text"]), this.status.text(o)
                        ...
                        return t.sort($.proxy((function(t, n) {
                            var i = $(t).find("td,th").eq(e),
                                r = $(n).find("td,th").eq(e),
                                s = this.getCellValue(i),
                                a = this.getCellValue(r);
                            return "ascending" === o ? s < a ? -1 : s > a ? 1 : 0 : a < s ? -1 : a > s ? 1 : 0
                        }), this))
                        ...
                        var t = {
                                686: function(t, e, o) {
                                    ...
                                    var c = function(t) {
                                        ...
                                        d = function(t, e) {
                                            var o = function(t) {
                                                ...
                                                o.style.fontSize = "12pt", o.style.border = "0", o.style.padding = "0", o.style.margin = "0", o.style.position = "absolute", o.style[e ? "right" : "left"] = "-9999px";
                                                var n = window.pageYOffset || document.documentElement.scrollTop;
                                                return o.style.top = "".concat(n, "px"), o.setAttribute("readonly", ""), o.value = t, o
                                            }(t);
                                            e.container.appendChild(o);
                                            var n = l()(o);
                                            return u("copy"), o.remove(), n
                                        },
                                        h = function(t) {
                                            var e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {
                                                ...
                                                o = "";
                                            return "string" == typeof t ? o = d(t, e) : t instanceof HTMLInputElement && !["text", "search", "url", "tel", "password"].includes(null == t ? void 0 : t.type) ? o = d(t.value, e) : (o = l()(t), u("copy")), o
                                        };
                                    ...
                                    var v = function(t) {
                                            ...
                                            var e, o, n, i, r, a = (i = l, r = function() {
                                            ...
                                            function l(t, e) {
                                                ...
                                                }(this, l), (o = a.call(this)).resolveOptions(e), o.listenClick(t), o
                                            }
                                            return e = l, o = [{
                                                key: "resolveOptions",
                                                value: function() {
                                                    ...
                                                    var e = t.delegateTarget || t.currentTarget,
                                                        ...
                                                        n = function() {
                                                            ...
                                                            if (void 0 !== i) {
                                                                ...
                                                                if ("copy" === o && i.hasAttribute("disabled")) throw new Error('Invalid "target" attribute. Please use "readonly" instead of "disabled" attribute');
                                                                if ("cut" === o && (i.hasAttribute("readonly") || i.hasAttribute("disabled"))) throw new Error('Invalid "target" attribute. You can\'t cut text from elements with "readonly" or "disabled" attributes')
                                                            }
                                                            return r ? h(r, {
                                                                container: n
                                                            }) : i ? "cut" === o ? c(i) : h(i, {
                                ...
                                438: function(t, e, o) {
                                    ...
                                    function i(t, e, o, n, i) {
                                        ...
                                        return t.addEventListener(o, s, i), {
                                            destroy: function() {
                                    ...
                                    t.exports = function(t, e, o, n, r) {
                                        return "function" == typeof t.addEventListener ? i.apply(null, arguments) : "function" == typeof o ? i.bind(null, document).apply(null, arguments) : ("string" == typeof t && (t = document.querySelectorAll(t)), Array.prototype.map.call(t, (function(t) {
                                            return i(t, e, o, n, r)
                                        })))
                                    }
                                },
                                ...
                                279: function(t) {
                                    ...
                                    e.prototype = {
                                        ...
                                        emit: function(t) {
                                            for (var e = [].slice.call(arguments, 1), o = ((this.e || (this.e = {}))[t] || []).slice(), n = 0, i = o.length; n < i; n++) o[n].fn.apply(o[n].ctx, e);
                                            return this
                                        },
                                        off: function(t, e) {
                                            var o = this.e || (this.e = {}),
                                                ...
                                                i = [];
                                            if (n && e)
                                                for (var r = 0, s = n.length; r < s; r++) n[r].fn !== e && n[r].fn._ !== e && i.push(n[r]);
            ...
            4: function(t, e, o) {
                ! function(t) {
                    ...
                    function i(t, e) {
                        ...
                        for (var n in t) {
                            var i = n.split(".");
                            Object.prototype.hasOwnProperty.call(t, n) && i[0] === e && (i.length > 1 && i.shift(), o[i.join(".")] = t[n])
                        }
                        return o
                    }
                    ...
                    function a(t, e) {
                        ...
                        "defineProperty" in Object && function() {
                        ...
                        }() || (e = Object.defineProperty, o = Object.prototype.hasOwnProperty("__defineGetter__"), n = "Getters & setters cannot be defined on this javascript engine", i = "A property cannot both have accessors and be writable or have a value", Object.defineProperty = function(t, r, s) {
                            ...
                            var a = String(r),
                                ...
                                u = "get" in s && typeof s.get,
                                c = "set" in s && typeof s.set;
                            if (u) {
                            ...
                            "Element" in this && "HTMLElement" in this || function() {
                                if (!window.Element || window.HTMLElement) {
                                    ...
                                    n.attachEvent("onpropertychange", (function(t) {
                                        for (var e, o = t.propertyName, r = !i.hasOwnProperty(o), a = n[o], l = i[o], u = -1; e = s[++u];) 1 === e.nodeType && (r || e[o] === l) && (e[o] = a);
                                        i[o] = a
                                    })), n.constructor = Element, n.hasAttribute || (n.hasAttribute = function(t) {
                                        return null !== this.getAttribute(t)
                                    }), u() || (document.onreadystatechange = u, t = setInterval(u, 25)), document.createElement = function(t) {
                                ...
                                function u() {
                                    return l-- || clearTimeout(t), !(!document.body || document.body.prototype || !/(complete|interactive)/.test(document.readyState) || (r(document, !0), t && document.body.prototype && clearTimeout(t), !document.body.prototype))
                                }
                            }()
                        }.call("object" == typeof window && window || "object" == typeof self && self || "object" == typeof o.g && o.g || {}),
                        function(t) {
                            (function() {
                                ...
                                get: function() {
                                    for (var t = this.attributes, e = {}, o = 0; o < t.length; o++) {
                                        var n = t[o];
                                        if (n && n.name && /^data-\w[.\w-]*$/.test(n.name)) {
                                            var i = n.name,
                                                r = n.value,
                                                s = i.substr(5).replace(/-./g, (function(t) {
                                                    return t.charAt(1).toUpperCase()
                                                }));
                                            "__defineGetter__" in Object.prototype && "__defineSetter__" in Object.prototype ? Object.defineProperty(e, s, {
                                                enumerable: !0,
                                                get: function() {
                                                    return this.value
                                                }.bind({
                        ...
                        function(t) {
                            ...
                            var o;
                            return this.hasIntlNumberFormatSupport() && (o = new Intl.NumberFormat(this.locale)), t.replace(/%{(.\S+)}/g, (function(t, n) {
                                if (Object.prototype.hasOwnProperty.call(e, n)) {
                                    var i = e[n];
                                    return !1 === i || "number" != typeof i && "string" != typeof i ? "" : "number" == typeof i ? o ? o.format(i) : i.toString() : i
                                }
                            ...
                            var o;
                            if (t + "." + (o = this.hasIntlPluralRulesSupport() ? new Intl.PluralRules(this.locale).select(e) : this.selectPluralFormUsingFallbackRules(e)) in this.translations) return o;
                            if (t + ".other" in this.translations) return console && "warn" in console && console.warn('i18n: Missing plural form ".' + o + '" for "' + this.locale + '" locale. Falling back to ".other".'), "other";
                            ...
                            var t = this.locale,
                                e = t.split("-")[0];
                            for (var o in a.pluralRulesMap)
                                if (Object.prototype.hasOwnProperty.call(a.pluralRulesMap, o))
                                    for (var n = a.pluralRulesMap[o], i = 0; i < n.length; i++)
                                        if (n[i] === t || n[i] === e) return o
                        }, a.pluralRulesMap = {
                            arabic: ["ar"],
                            ...
                            russian: function(t) {
                                var e = t % 100,
                                    o = e % 10;
                                return 1 === o && 11 !== e ? "one" : o >= 2 && o <= 4 && !(e >= 12 && e <= 14) ? "few" : 0 === o || o >= 5 && o <= 9 || e >= 11 && e <= 14 ? "many" : "other"
                            },
                            scottish: function(t) {
                                ...
                                return function(e, n) {
                                    var i = this,
                                        ...
                                        d = function() {
                                            ...
                                            for ("" === (r = "object" == typeof e[n] ? ("" + e[n].baseVal).replace(/^\s+|\s+$/g, "").split(l) : ("" + e[n]).replace(/^\s+|\s+$/g, "").split(l))[0] && (r = []), s = {}, o = 0; o < r.length; ++o) s[r[o]] = !0;
                                            a = r.length, c()
                                        };
                                    return d(), o(i, "length", (function() {
                                        ...
                                        for (var t, o, l = 0, u = t.length; l < u; ++l) s[o = t[l]] || (r.push(o), s[o] = !0);
                                        a !== r.length && (a = r.length >>> 0, "object" == typeof e[n] ? e[n].baseVal = r.join(" ") : e[n] = r.join(" "), c())
                                    }, i.remove = function() {
                                        d.apply(i, t = arguments);
                                        for (var t, o = {}, l = 0, u = []; l < t.length; ++l) o[t[l]] = !0, delete s[t[l]];
                                        for (l = 0; l < r.length; ++l) o[r[l]] || u.push(r[l]);
                                        r = u, a = u.length >>> 0, "object" == typeof e[n] ? e[n].baseVal = r.join(" ") : e[n] = r.join(" "), c()
                                    }, i.toggle = function(e, o) {
                                        return d.apply(i, [e]), t !== o ? o ? (i.add(e), !0) : (i.remove(e), !1) : s[e] ? (i.remove(e), !1) : (i.add(e), !0)
                                    }, i
                                }
                                ...
                                var n = function(t, i, r) {
                                    o(t.prototype, i, (function() {
                                        ...
                                        if (s[a] = !0, !1 === e) {
                                            ...
                                            l || (l = u.appendChild(document.createElement("div"))), t = DOMTokenList.call(l, s, r)
                                        } else t = new DOMTokenList(s, r);
                                        return o(s, i, (function() {
                                            return t
                                        })), delete s[a], t
                                    }), !0)
                                };
                        ...
                        function(t) {
                            "document" in this && "matches" in document.documentElement || (Element.prototype.matches = Element.prototype.webkitMatchesSelector || Element.prototype.oMatchesSelector || Element.prototype.msMatchesSelector || Element.prototype.mozMatchesSelector || function(t) {
                                for (var e = this, o = (e.document || e.ownerDocument).querySelectorAll(t), n = 0; o[n] && o[n] !== e;) ++n;
                                return !!o[n]
                            })
                        }.call("object" == typeof window && window || "object" == typeof self && self || "object" == typeof o.g && o.g || {}),
                        function(t) {
                            ...
                            (function(t) {
                                ...
                                if ("undefined" != typeof document && "undefined" != typeof window) {
                                    ...
                                    window.Event = Window.prototype.Event = function(e, o) {
                                        ...
                                        return (n = document.createEventObject()).type = e, n.bubbles = !(!o || o.bubbles === t) && o.bubbles, n.cancelable = !(!o || o.cancelable === t) && o.cancelable, n
                                        ...
                                        var t = this,
                                            o = arguments[0],
                                            i = arguments[1];
                                        if (t === window && o in e) throw new Error("In IE8 the event: " + o + " is not available on the window object. Please see https://github.com/Financial-Times/polyfill-service/issues/317 for more information.");
                                        t._events || (t._events = {}), t._events[o] || (t._events[o] = function(e) {
                                            var o, i = t._events[e.type].list,
                                                r = i.slice(),
                                                s = -1,
                                                a = r.length;
                                            for (e.preventDefault = function() {
                                                ...
                                                }, e.currentTarget = t, e.relatedTarget = e.fromElement || null, e.target = e.target || e.srcElement || t, e.timeStamp = (new Date).getTime(), e.clientX && (e.pageX = e.clientX + document.documentElement.scrollLeft, e.pageY = e.clientY + document.documentElement.scrollTop); ++s < a && !e.cancelImmediate;) s in r && -1 !== n(i, o = r[s]) && "function" == typeof o && o.call(t, e)
                                        ...
                                        var t, e = this,
                                            o = arguments[0],
                                            i = arguments[1];
                                        e._events && e._events[o] && e._events[o].list && -1 !== (t = n(e._events[o].list, i)) && (e._events[o].list.splice(t, 1), e._events[o].list.length || (e.detachEvent && e.detachEvent("on" + o, e._events[o]), delete e._events[o]))
                                        ...
                                        try {
                                            ...
                                            t.target = e;
                                            do {
                                                t.currentTarget = e, "_events" in e && "function" == typeof e._events[o] && e._events[o].call(e, t), "function" == typeof e["on" + o] && e["on" + o].call(e, t), e = 9 === e.nodeType ? e.parentWindow : e.parentNode
                        ...
                        function(t) {
                            "bind" in Function.prototype || Object.defineProperty(Function.prototype, "bind", {
                                value: function(t) {
                                    ...
                                    for (var m, g = c.call(arguments, 1), b = p(0, f.length - g.length), y = [], v = 0; v < b; v++) h.call(y, "$" + v);
                                    return m = Function("binder", "return function (" + y.join(",") + "){ return binder.apply(this, arguments); }")((function() {
                                        if (this instanceof m) {
                                            var e = f.apply(this, d.call(g, c.call(arguments)));
                                            return n(e) === e ? e : this
                                        }
                                        return f.apply(t, d.call(g, c.call(arguments)))
                                    })), f.prototype && (s.prototype = f.prototype, m.prototype = new s, s.prototype = null), m
                                }
                            })
                        }.call("object" == typeof window && window || "object" == typeof self && self || "object" == typeof o.g && o.g || {});
                    var l = {
                    ...
                    u.prototype.init = function() {
                    ...
                    }, u.prototype.initControls = function() {
                    ...
                    }, u.prototype.initSectionHeaders = function() {
                        var t = this;
                        e(this.$sections, (function(e, o) {
                            var n = e.querySelector("." + t.sectionHeaderClass);
                            n && (t.constructHeaderMarkup(n, o), t.setExpanded(t.isExpanded(e), e), n.addEventListener("click", t.onSectionToggle.bind(t, e)), t.setInitialState(e))
                        }))
                    }, u.prototype.constructHeaderMarkup = function(t, e) {
                        var o = t.querySelector("." + this.sectionButtonClass),
                        ...
                        if (o && n) {
                            ...
                            for (var s = 0; s < o.attributes.length; s++) {
                                var a = o.attributes.item(s);
                                "id" !== a.nodeName && r.setAttribute(a.nodeName, a.nodeValue)
                            }
                            var l = document.createElement("span");
                            l.classList.add(this.sectionHeadingTextClass), l.id = o.id;
                            var u = document.createElement("span");
                            u.classList.add(this.sectionHeadingTextFocusClass), l.appendChild(u), u.innerHTML = o.innerHTML;
                            var c = document.createElement("span");
                            c.classList.add(this.sectionShowHideToggleClass), c.setAttribute("data-nosnippet", "");
                            var d = document.createElement("span");
                            d.classList.add(this.sectionShowHideToggleFocusClass), c.appendChild(d);
                            var h = document.createElement("span"),
                                p = document.createElement("span");
                            if (p.classList.add(this.upChevronIconClass), d.appendChild(p), h.classList.add(this.sectionShowHideTextClass), d.appendChild(h), r.appendChild(l), r.appendChild(this.getButtonPunctuationEl()), i) {
                                var f = document.createElement("span"),
                                    m = document.createElement("span");
                                m.classList.add(this.sectionSummaryFocusClass), f.appendChild(m);
                                for (var g = 0, b = i.attributes.length; g < b; ++g) {
                                    var y = i.attributes.item(g).nodeName,
                                        v = i.attributes.item(g).nodeValue;
                                    f.setAttribute(y, v)
                                }
                                m.innerHTML = i.innerHTML, i.parentNode.replaceChild(f, i), r.appendChild(f), r.appendChild(this.getButtonPunctuationEl())
                            }
                            r.appendChild(c), n.removeChild(o), n.appendChild(r)
                        }
                    }, u.prototype.onBeforeMatch = function(t) {
                        var e = t.target;
                        if (e instanceof Element) {
                            var o = e.closest("." + this.sectionClass);
                            o && this.setExpanded(!0, o)
                        }
                    }, u.prototype.onSectionToggle = function(t) {
                        var e = this.isExpanded(t);
                        this.setExpanded(!e, t), this.storeState(t)
                    }, u.prototype.onShowOrHideAllToggle = function() {
                        var t = this,
                            o = this.$sections,
                    ...
                    }, u.prototype.setExpanded = function(t, e) {
                        var o = e.querySelector("." + this.upChevronIconClass),
                        ...
                        if (o && n instanceof HTMLElement && i && r) {
                            var s = t ? this.i18n.t("hideSection") : this.i18n.t("showSection");
                            n.innerText = s, i.setAttribute("aria-expanded", t.toString());
                            var a = [],
                                l = e.querySelector("." + this.sectionHeadingTextClass);
                            l instanceof HTMLElement && a.push(l.innerText.trim());
                            var u = e.querySelector("." + this.sectionSummaryClass);
                            u instanceof HTMLElement && a.push(u.innerText.trim());
                            var c = t ? this.i18n.t("hideSectionAriaLabel") : this.i18n.t("showSectionAriaLabel");
                            a.push(c), i.setAttribute("aria-label", a.join(" , ")), t ? (r.removeAttribute("hidden"), e.classList.add(this.sectionExpandedClass), o.classList.remove(this.downChevronIconClass)) : (r.setAttribute("hidden", "until-found"), e.classList.remove(this.sectionExpandedClass), o.classList.add(this.downChevronIconClass));
                            var d = this.checkIfAllSectionsOpen();
                            this.updateShowAllButton(d)
                        }
                    }, u.prototype.isExpanded = function(t) {
                        return t.classList.contains(this.sectionExpandedClass)
                    }, u.prototype.checkIfAllSectionsOpen = function() {
                        return this.$sections.length === this.$module.querySelectorAll("." + this.sectionExpandedClass).length
                    }, u.prototype.updateShowAllButton = function(t) {
                    ...
                    u.prototype.storeState = function(t) {
                    ...
                    }, u.prototype.getButtonPunctuationEl = function() {
                        var t = document.createElement("span");
                    ...
                    d.prototype.init = function() {
                        ...
                        }, d.prototype.debounce = function(t) {
                    ...
                    function p(t, e) {
                        ...
                        var r, l, u, c = {
                            ...
                            d = s(t.dataset),
                            p = {};
                        if (("maxwords" in d || "maxlength" in d) && (p = {
                                maxlength: !1,
                                maxwords: !1
                            }), this.config = n(c, e || {}, p, d), this.i18n = new a(i(this.config, "i18n"), {
                                locale: (r = t, l = "lang", u = r.closest("[" + l + "]"), u ? u.getAttribute(l) : null)
                            }), this.maxLength = 1 / 0, "maxwords" in this.config && this.config.maxwords) this.maxLength = this.config.maxwords;
                        else {
                    ...
                    p.prototype.init = function() {
                        if (this.$module && this.$textarea) {
                            ...
                            if (e) {
                                ...
                                o.className = "govuk-character-count__sr-status govuk-visually-hidden", o.setAttribute("aria-live", "polite"), this.$screenReaderCountMessage = o, e.insertAdjacentElement("afterend", o);
                                var n = document.createElement("div");
                                n.className = e.className, n.classList.add("govuk-character-count__status"), n.setAttribute("aria-hidden", "true"), this.$visibleCountMessage = n, e.insertAdjacentElement("afterend", n), e.classList.add("govuk-visually-hidden"), t.removeAttribute("maxlength"), this.bindChangeEvents(), window.addEventListener("onpageshow" in window ? "pageshow" : "DOMContentLoaded", this.updateCountMessage.bind(this)), this.updateCountMessage()
                            }
                        }
                        ...
                        var o = t < 0 ? "OverLimit" : "UnderLimit";
                        return this.i18n.t(e + o, {
                            count: Math.abs(t)
                        })
                        ...
                        if (e) {
                            ...
                            if (o && o.classList.contains("govuk-checkboxes__conditional")) {
                                var n = t.checked;
                                t.setAttribute("aria-expanded", n.toString()), o.classList.toggle("govuk-checkboxes__conditional--hidden", !n)
                            }
                        }
                    }, f.prototype.unCheckAllInputsExcept = function(t) {
                        var o = this;
                        e(document.querySelectorAll('input[type="checkbox"][name="' + t.name + '"]'), (function(e) {
                            t.form === e.form && e !== t && (e.checked = !1, o.syncConditionalRevealWithInputState(e))
                        }))
                    }, f.prototype.unCheckExclusiveInputs = function(t) {
                        var o = this;
                        e(document.querySelectorAll('input[data-behaviour="exclusive"][type="checkbox"][name="' + t.name + '"]'), (function(e) {
                            t.form === e.form && (e.checked = !1, o.syncConditionalRevealWithInputState(e))
                        }))
                    ...
                    m.prototype.init = function() {
                        ...
                        }, m.prototype.polyfillDetails = function() {
                            var t, e = this.$module,
                                o = this.$summary = e.getElementsByTagName("summary").item(0),
                                n = this.$content = e.getElementsByTagName("div").item(0);
                            o && n && (n.id || (n.id = "details-content-" + (t = (new Date).getTime(), void 0 !== window.performance && "function" == typeof window.performance.now && (t += window.performance.now()), "xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replace(/[xy]/g, (function(e) {
                                var o = (t + 16 * Math.random()) % 16 | 0;
                                return t = Math.floor(t / 16), ("x" === e ? o : 3 & o | 8).toString(16)
                            })))), e.setAttribute("role", "group"), o.setAttribute("role", "button"), o.setAttribute("aria-controls", n.id), o.tabIndex = 0, this.$module.hasAttribute("open") ? o.setAttribute("aria-expanded", "true") : (o.setAttribute("aria-expanded", "false"), n.style.display = "none"), this.polyfillHandleInputs(this.polyfillSetAttributes.bind(this)))
                        }, m.prototype.polyfillSetAttributes = function() {
                        ...
                        }, m.prototype.polyfillHandleInputs = function(t) {
                            this.$summary.addEventListener("keypress", (function(e) {
                                var o = e.target;
                                13 !== e.keyCode && 32 !== e.keyCode || o instanceof HTMLElement && "summary" === o.nodeName.toLowerCase() && (e.preventDefault(), o.click ? o.click() : t(e))
                        ...
                        }, g.prototype.focusTarget = function(t) {
                            ...
                            return !!n && (n.scrollIntoView(), o.focus({
                                preventScroll: !0
                            }), !0)
                        }, g.prototype.getFragmentFromUrl = function(t) {
                            if (-1 !== t.indexOf("#")) return t.split("#").pop()
                        }, g.prototype.getAssociatedLegendOrLabel = function(t) {
                            ...
                            if (e) {
                                var o = document.getElementById(e);
                                if (o && o.classList.contains("govuk-radios__conditional")) {
                                    var n = t.checked;
                                    t.setAttribute("aria-expanded", n.toString()), o.classList.toggle("govuk-radios__conditional--hidden", !n)
                                }
                            }
                        }, v.prototype.handleClick = function(t) {
                            var o = this,
                                n = t.target;
                            if (n instanceof HTMLInputElement && "radio" === n.type) {
                                var i = document.querySelectorAll('input[type="radio"][aria-controls]'),
                                    r = n.form,
                                    s = n.name;
                                e(i, (function(t) {
                                    var e = t.form === r;
                                    t.name === s && e && o.syncConditionalRevealWithInputState(t)
                                }))
                            }
                        ...
                        function(t) {
                        ...
                        }.call("object" == typeof window && window || "object" == typeof self && self || "object" == typeof o.g && o.g || {}), x.prototype.init = function() {
                            this.$module && this.$tabs && ("function" == typeof window.matchMedia ? this.setupResponsiveChecks() : this.setup())
                        }, x.prototype.setupResponsiveChecks = function() {
                            this.mql = window.matchMedia("(min-width: 40.0625em)"), this.mql.addListener(this.checkMode.bind(this)), this.checkMode()
                        }, x.prototype.checkMode = function() {
                            this.mql.matches ? this.setup() : this.teardown()
                        }, x.prototype.setup = function() {
                            var t = this,
                                o = this.$module,
                                n = this.$tabs,
                                i = o.querySelector(".govuk-tabs__list"),
                                r = o.querySelectorAll(".govuk-tabs__list-item");
                            if (n && i && r) {
                                i.setAttribute("role", "tablist"), e(r, (function(t) {
                            ...
                            var t = this,
                                ...
                                n = this.$tabs,
                                i = o.querySelector(".govuk-tabs__list"),
                                r = o.querySelectorAll("a.govuk-tabs__list-item");
                            n && i && r && (i.removeAttribute("role"), e(r, (function(t) {
                        ...
                        }, x.prototype.onHashChange = function() {
                            ...
                            if (e)
                                if (this.changingHash) this.changingHash = !1;
                                    ...
                                    o && (this.hideTab(o), this.showTab(e), e.focus())
                                }
                        }, x.prototype.hideTab = function(t) {
                            this.unhighlightTab(t), this.hidePanel(t)
                        }, x.prototype.showTab = function(t) {
                            this.highlightTab(t), this.showPanel(t)
                        }, x.prototype.getTab = function(t) {
                            return this.$module.querySelector('a.govuk-tabs__tab[href="' + t + '"]')
                        }, x.prototype.setAttributes = function(t) {
                            ...
                            o && (o.setAttribute("role", "tabpanel"), o.setAttribute("aria-labelledby", t.id), o.classList.add(this.jsHiddenClass))
                        }, x.prototype.unsetAttributes = function(t) {
                        ...
                        }, x.prototype.onTabClick = function(t) {
                            var e = this.getCurrentTab(),
                                o = t.currentTarget;
                            e && o instanceof HTMLAnchorElement && (t.preventDefault(), this.hideTab(e), this.showTab(o), this.createHistoryEntry(o))
                        }, x.prototype.createHistoryEntry = function(t) {
                            var e = this.getPanel(t);
                            if (e) {
                                var o = e.id;
                                e.id = "", this.changingHash = !0, window.location.hash = this.getHref(t).slice(1), e.id = o
                            }
                        }, x.prototype.onTabKeydown = function(t) {
                            switch (t.keyCode) {
                                case this.keys.left:
                                case this.keys.up:
                        ...
                        }, x.prototype.getPanel = function(t) {
                            return this.$module.querySelector(this.getHref(t))
                        }, x.prototype.showPanel = function(t) {
                            var e = this.getPanel(t);
                            e && e.classList.remove(this.jsHiddenClass)
                        }, x.prototype.hidePanel = function(t) {
                            var e = this.getPanel(t);
                            e && e.classList.add(this.jsHiddenClass)
                        }, x.prototype.unhighlightTab = function(t) {
                        ...
                        }, x.prototype.highlightTab = function(t) {
                        ...
                        }, x.prototype.getCurrentTab = function() {
                            return this.$module.querySelector(".govuk-tabs__list-item--selected a.govuk-tabs__tab")
                        }, x.prototype.getHref = function(t) {
                            var e = t.getAttribute("href");
                            return e.slice(e.indexOf("#"), e.length)
                        }, t.initAll = function(t) {
                            var o = (t = void 0 !== t ? t : {}).scope instanceof HTMLElement ? t.scope : document;
                            e(o.querySelectorAll('[data-module="govuk-accordion"]'), (function(e) {
                                new u(e, t.accordion).init()
                            })), e(o.querySelectorAll('[data-module="govuk-button"]'), (function(e) {
                                new d(e, t.button).init()
                            })), e(o.querySelectorAll('[data-module="govuk-character-count"]'), (function(e) {
                                new p(e, t.characterCount).init()
                            })), e(o.querySelectorAll('[data-module="govuk-checkboxes"]'), (function(t) {
                                new f(t).init()
                            })), e(o.querySelectorAll('[data-module="govuk-details"]'), (function(t) {
                                new m(t).init()
                            }));
                            var n = o.querySelector('[data-module="govuk-error-summary"]');
                            n && new g(n, t.errorSummary).init();
                            var i = o.querySelector('[data-module="govuk-header"]');
                            i && new b(i).init(), e(o.querySelectorAll('[data-module="govuk-notification-banner"]'), (function(e) {
                                new y(e, t.notificationBanner).init()
                            })), e(o.querySelectorAll('[data-module="govuk-radios"]'), (function(t) {
                                new v(t).init()
                            }));
                            var r = o.querySelector('[data-module="govuk-skip-link"]');
                            r && new w(r).init(), e(o.querySelectorAll('[data-module="govuk-tabs"]'), (function(t) {
                                new x(t).init()
                            }))
                        }, t.version = "4.6.0", t.Accordion = u, t.Button = d, t.Details = m, t.CharacterCount = p, t.Checkboxes = f, t.ErrorSummary = g, t.Header = b, t.NotificationBanner = y, t.Radios = v, t.SkipLink = w, t.Tabs = x
                }(e)
            }
        },
        e = {};
    ...
    o.n = t => {
        ...
        r.prototype.init = function() {
            ...
            this.$module.querySelector('[name="accept"]').addEventListener("click", this.accept.bind(this)), this.$module.querySelector('[name="reject"]').addEventListener("click", this.reject.bind(this));
            ...
            if (t.analytics) {
                ...
                window.dataLayer = window.dataLayer || [], e("js", new Date), e("config", "G-VTGX4YLSVL")
            } else window["ga-disable-G-VTGX4YLSVL"] = !0;
            this.hideMessage()
            ...
            localStorage.setItem("mojpl-cookies", JSON.stringify(t)), this.load(t)
        ...
        u.prototype.init = function() {
            ...
            e.className = "app-copy-button js-copy-button", e.setAttribute("aria-live", "assertive"), e.textContent = "Copy code", t.insertBefore(e, t.firstChild), this.copyAction()
            ...
            try {
                new(l())(".js-copy-button", {
                    ...
                    t.trigger.textContent = "Code copied", t.clearSelection(), setTimeout((function() {
        ...
        const c = u,
            d = function(t) {
                this.container = t, this.keys = {
                    left: 37,
                    right: 39,
                    up: 38,
                    down: 40
                }, this.cssHide = "app-tabs__panel--hidden", this.tabs = t.find(".app-tabs__tab"), this.panels = t.find(".app-tabs__panel"), this.container.on("click", "[role=tab]", $.proxy(this, "onTabClick")), this.container.on("keydown", "[role=tab]", $.proxy(this, "onTabKeydown")), this.container.on("click", ".app-tabs__close", $.proxy(this, "onCloseButtonClick")), this.setupHtml()
            };
        d.prototype.hasTab = function(t) {
            ...
            this.container.find(".app-tabs__list").attr("role", "tablist"), this.container.find(".app-tabs__list-item").attr("role", "presentation"), this.tabs.attr("role", "tab"), this.panels.attr("role", "tabpanel"), this.tabs.each($.proxy((function(t, e) {
                let o = this.getHref($(e)).slice(1);
                e.id = "tab_" + o, $(e).attr("aria-controls", o)
            }), this)), this.panels.each($.proxy((function(t, e) {
                $(e).attr("aria-labelledby", this.tabs[t].id)
            }), this)), this.panels.addClass(this.cssHide)
